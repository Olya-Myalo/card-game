/******/ (() => {
  ...
  \************************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ renderDifficultySelectionPage: () =>
            /* binding */ renderDifficultySelectionPage,
          /* harmony export */
        });
        /* harmony import */ var _page_level_difficulty__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./page-level-difficulty */ "./component/page-level-difficulty.ts",
          );
        ...
        function renderDifficultySelectionPage() {
          ...
          var difficultyInputs = document.querySelectorAll(
          ...
          function startGame(difficulty) {
            (0,
            _page_level_difficulty__WEBPACK_IMPORTED_MODULE_0__.renderPageLevelDifficulty)(
              difficulty,
            );
          }
        }
  ...
  \********************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ getNumCards: () => /* binding */ getNumCards,
          /* harmony export */ renderPageLevelDifficulty: () =>
            /* binding */ renderPageLevelDifficulty,
          /* harmony export */ shuffle: () => /* binding */ shuffle,
          /* harmony export */
        });
        /* harmony import */ var _array_ards__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./array-сards */ "./component/array-сards.ts",
          );
        var __spreadArray =
        ...
        function renderPageLevelDifficulty(difficulty) {
          var shuffledCards = shuffle(
            __spreadArray(
              __spreadArray(
                [],
                _array_ards__WEBPACK_IMPORTED_MODULE_0__.cards,
                true,
              ),
              _array_ards__WEBPACK_IMPORTED_MODULE_0__.cards,
              true,
          ...
          function renderCards(difficulty, cards) {
            ...
            var duplicatedCards = __spreadArray(
              __spreadArray([], selectedCards, true),
              selectedCards,
              true,
            );
          ...
          if (flippedFirstCardId === "") {
            ...
            if (flippedFirstCardId === cardId) {
              ...
              if (cardsCount === totalCards) {
                var formattedTime =
                  (_a = document.querySelector(".page-maps_time-figure")) ===
                    null || _a === void 0
                    ? void 0
                    : _a.textContent;
                clearInterval(timerInterval);
              ...
              formattedTime =
                (_b = document.querySelector(".page-maps_time-figure")) ===
                  null || _b === void 0
                  ? void 0
                  : _b.textContent;
              clearInterval(timerInterval);
  ...
  \******************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _component_difficulty_selection_page__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(
        /*! ./component/difficulty-selection-page */ "./component/difficulty-selection-page.ts",
      );

    (0,
    _component_difficulty_selection_page__WEBPACK_IMPORTED_MODULE_0__.renderDifficultySelectionPage)();
  })();
